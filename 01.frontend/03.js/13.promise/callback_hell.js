/**
 * js는 비동기 처리를 위한 하나의 패턴으로 콜백함수패턴을 사용함.
 * 이러한 콜백함수 패턴은 콜백 헬이라고 하는 가동성이 떨어지는 코드를 만들기 쉬움.
 */

// 전통적인 콜백 패턴

// 1. XMLHttpRequest 객체 불러오기
...
// Callback hell 
// 비동기 처리(HTTP 요청)의 결과로 얻은 값(post/1)으로 다시 비동기 요청을 하고자할 때
// 발생되는 가독성 저하 케이스
