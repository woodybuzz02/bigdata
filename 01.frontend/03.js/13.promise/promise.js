 ...
 * 대처장안으로 ES6문법의 Promise가 등장
 * 
 * 1. Promise 생성 방식
 * 2. Promise의 상태 정보(pending, fulfilled, rejected) pending 요청준비
 * 3. reject(), resolce()
 * 
...
const promise = new Promise((resolve, reject) => {
    // 현재 17번 라인의 위치 : promise() 생성자 함수의 콜백함수 내부에서 비동기 처리 수행할 예정
...
console.log(promise); // 비동기 처리의 진행 상태(경과)를 나타내는 상태 정보(state)를 가짐
